...
%%------------------------------------------------------------
 ...
 \ntsetup{doctype=mscplan}       % The type of document
%                               %     [     phd —> PhD thesis
...
%                               % DEFAULT: doctype=phd
 ...
 \ntsetup{school=nova/fct/green}    % The school id
...
\ntsetup{media=screen}         % The target media for the PDF
...
\ntsetup{abstractorder={en,pt}}        % The order for abstracts for the main language
